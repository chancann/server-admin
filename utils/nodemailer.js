...
async function nodemailerFunc(to, password, subject) {
                ...
                >
                  ...
                  <tr>
                    <td style="padding: 0 35px">
                      ...
                      <span style="display: inline-block; vertical-align: middle; margin: 29px 0 26px; border-bottom: 1px solid #cecece; width: 100px">${password}</span>
                      ...
                      <a href="javascript:void(0);" style="background: #20e277; text-decoration: none !important; font-weight: 500; margin-top: 35px; color: #fff; text-transform: uppercase; font-size: 14px; padding: 10px 24px; display: inline-block; border-radius: 50px">Reset Password</a>
                    </td>
                  </tr>
                  <tr>
                    <td style="height: 40px">&nbsp;</td>
